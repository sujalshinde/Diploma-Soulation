...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Easy-Diploma Soluation</h1>
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3"></i> All Subjects</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-users mr-3"></i> 2nd/3rd Year</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-keyboard mr-3"></i> Lifetime Access</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign mr-3"></i>Less Money</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Welcome To "Diploma Solution", Here We Provide You Syllabus, Sample Question Paper, Answer Paper, MCQs, Notes, Books, Programs, Video Lecture, Micro-Project and Final Year Project.
                 This Website Is Specially Made For MSBTE All Branch Students. We Give Our 100% Implementation.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            ...
            <a class="text-dark" href="#">operating system</a><br />
            <a class="text-dark" href="#">Java</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>rohitjadhav717409@gmail.com <br> Ph. 7709597174 </p>
          </div>
        </div>
      </div>
